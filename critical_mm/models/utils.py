...
from torch.optim import SGD, Adam, Optimizer, RAdam
...
class JsonResultLoggingEncoder(JSONEncoder):
    ...
    def default(self, obj):
        ...
        if isinstance(obj, tuple):
            if obj and isinstance(obj[0], (torch.Tensor, np.ndarray)):
...
class JSONMetricsLogger(Logger):
    def __init__(self, output_dir=None, **kwargs):
        ...
        logging.info(f"logging metrics to file: {output_dir.resolve()!s}")
